document.addEventListener('DOMContentLoaded', () => {
    const questions = [
        { question: "종합비타민 제품을 먹으면 <br> 충분하게 비타민을 충족할 수 있어요.", answer: "X" },
        { question: "내가 먹는 영양제에 <br> 중복되는 성분이 있는지 알고 있어요.", answer: "O" },
        { question: "임산부라면 비타민A는 반드시 피해야해요.", answer: "X" },
        { question: "집에 있는 영양제의 이름과 성분을 전부 알아요.", answer: "O" },
        { question: "고용량 비오틴을 장기간 섭취시 <br> 문제가 될 수 있는 성분은 판토텐산이에요.", answer: "O" },
        { question: "한국인 영양소 섭취기준에 따르면 <br> 비타민C의 상한 섭취량은 없어요 .", answer: "X" },
        { question: "여드름에 먹는 처방약(이소트레티노인)과 <br>비타민A는 궁합이 잘 맞아요. ", answer: "X" },
        { question: "마그네슘을 과하게 먹으면 <br>변비가 생길 수 있어요.", answer: "X" },
        { question: "비타민B군이 들어간 영양제를 먹고<br> 소변색이 노랗다면 병원에 가야해요.", answer: "X" },
        { question: "오메가3를 먹기 위한 <br> 가장 좋은 시간은 아침 공복이에요.", answer: "X" }
    ];
    ...
    function updateQuestion() {
        if (currentQuestionIndex === -1) {
            questionText.innerHTML = "나는 영양제를 잘 고르고 있을까? <br> 영양제 OX퀴즈를 통해 <br>나의 영양제 레벨을 알아보세요. <br> <br> <br>퀴즈를 다 풀면 선물이 있어요.<br> p.s. 퀴즈의 해답이 궁금하다면 핏타민을 방문해보세요.";
    ...
    function showResult() {
        ...
        let message;
        if (score <= 4) {
            message = "영양제가 너무너무 어려운 당신, <br> 핏타민이 도와줄게요! <br>어려운 영양제 고민하지 말고 <br>약사 상담을 통해 <br>자기에게 딱 맞는 영양제를 설계해보세요!";
